...
const Landing = () => {
  ...
  const scrollToSection = (elementRef) => {
    if (elementRef?.current) {
      ...
      const elementPosition = elementRef.current.offsetTop - navHeight;
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled 
          ? `${isDarkMode ? 'bg-gray-900/20' : 'bg-white/20'} backdrop-blur-xl border-b ${isDarkMode ? 'border-white/10' : 'border-gray-200/20'} shadow-2xl` 
          : 'bg-transparent'
      }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`flex items-center justify-between transition-all duration-300 ${
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              >
                Home
                <span className={`absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-600 transition-all duration-300 ${
          ...
          <div className={`md:hidden ${isDarkMode ? 'bg-gray-900/95' : 'bg-white/95'} backdrop-blur-xl border-t ${isDarkMode ? 'border-white/10' : 'border-gray-200/20'}`}>
            <div className="px-4 py-6 space-y-4">
              <button 
                ...
                className={`block w-full text-left py-3 px-2 font-medium rounded-lg transition-all duration-300 ${
              ...
              <div className="pt-2">
                <Button 
                  variant="outline" 
                  size="sm" 
                  className={`w-full ${isDarkMode ? 'border-white/20 text-white hover:bg-white/10' : 'border-gray-300 hover:bg-gray-100'} backdrop-blur-sm`}
                >
                  Sign In
                </Button>
              </div>
      ...
      <section ref={demoRef} className={`py-20 px-4 sm:px-6 lg:px-8 ${isDarkMode ? 'bg-black/10' : 'bg-white/30'} backdrop-blur-sm`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl max-w-3xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Experience the power of our visual parking layout designer with real-time monitoring and management
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
                    <div className="flex items-center gap-4">
                      <Button
                        ...
                        size="sm"
                        className={`${
                          isDarkMode ? 'bg-white/5 border-white/20 hover:bg-white/10' : 'bg-gray-900/5 border-gray-200/30 hover:bg-gray-900/10'
                        } backdrop-blur-sm transition-all duration-300`}
                      >
                        {currentFeature % 2 === 0 ? <Play className="w-4 h-4" /> : <Settings className="w-4 h-4" />}
                        Live Demo
                      </Button>
                      <Button
                        variant="outline"
                    ...
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className={`${
                        isDarkMode ? 'bg-red-500/10 border-red-500/30' : 'bg-red-500/20 border-red-500/40'
                      } backdrop-blur-sm`}>
                        <span className="w-2 h-2 bg-red-500 rounded-full mr-1 animate-pulse"></span>
                        8 Occupied
                      </Badge>
                      <Badge variant="outline" className={`${
                        isDarkMode ? 'bg-green-500/10 border-green-500/30' : 'bg-green-500/20 border-green-500/40'
                      } backdrop-blur-sm`}>
                        <span className="w-2 h-2 bg-green-500 rounded-full mr-1"></span>
                        5 Available
                      </Badge>
                      <Badge variant="outline" className={`${
                        isDarkMode ? 'bg-yellow-500/10 border-yellow-500/30' : 'bg-yellow-500/20 border-yellow-500/40'
                      } backdrop-blur-sm`}>
                        <span className="w-2 h-2 bg-yellow-500 rounded-full mr-1"></span>
                        4 Reserved
                      </Badge>
                      <Badge variant="outline" className={`${
                        isDarkMode ? 'bg-blue-500/10 border-blue-500/30' : 'bg-blue-500/20 border-blue-500/40'
                      } backdrop-blur-sm`}>
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      Click on any parking slot to see detailed management options
                    </p>
                  </div>

                  {/* Enhanced Parking Layout */}
                  <div className={`relative ${
                    isDarkMode ? 'bg-gray-900/30' : 'bg-gray-100/30'
                  } backdrop-blur-sm rounded-2xl p-8 min-h-[400px] border ${
                    ...
                    <div className="grid grid-cols-5 gap-3 mb-6">
                      {Array.from({ length: 20 }, (_, i) => {
                        const slot = {
                          id: i + 1,
                          status: i % 4 === 0 ? 'occupied' : i % 4 === 1 ? 'available' : i % 4 === 2 ? 'reserved' : 'charging',
                          type: i % 5 === 0 ? 'ev' : i % 5 === 1 ? 'handicapped' : i % 5 === 2 ? 'vip' : 'regular',
                          price: i % 3 === 0 ? '€2.50/hr' : i % 3 === 1 ? '€1.80/hr' : '€3.00/hr',
                          customer: i % 4 === 0 ? `Customer ${i + 1}` : null,
                          timeLeft: i % 4 === 0 ? `${Math.floor(Math.random() * 180) + 30}min` : null
                        };

                        const getSlotColor = (status) => {
                          switch (status) {
                            case 'occupied': return isDarkMode ? 'bg-red-500/20 border-red-500 hover:bg-red-500/30' : 'bg-red-500/30 border-red-600 hover:bg-red-500/40';
                            case 'available': return isDarkMode ? 'bg-green-500/20 border-green-500 hover:bg-green-500/30' : 'bg-green-500/30 border-green-600 hover:bg-green-500/40';
                            case 'reserved': return isDarkMode ? 'bg-yellow-500/20 border-yellow-500 hover:bg-yellow-500/30' : 'bg-yellow-500/30 border-yellow-600 hover:bg-yellow-500/40';
                            case 'charging': return isDarkMode ? 'bg-blue-500/20 border-blue-500 hover:bg-blue-500/30' : 'bg-blue-500/30 border-blue-600 hover:bg-blue-500/40';
                            default: return isDarkMode ? 'bg-gray-500/20 border-gray-500 hover:bg-gray-500/30' : 'bg-gray-500/30 border-gray-600 hover:bg-gray-500/40';
                          }
                        };
                        ...
                        return (
                          <div
                            ...
                            className={`
                              ...
                              ${selectedSlot?.id === slot.id ? 'ring-2 ring-blue-400 shadow-[0_0_20px_rgba(59,130,246,0.5)] scale-110' : ''}
                          ...
                          >
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-xs font-medium">
                              <div className="text-lg mb-1">{getStatusIcon(slot.status)}</div>
                              <div className={`text-[10px] ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{slot.id}</div>
                            </div>
                            ...
                            {slot.type !== 'regular' && (
                              <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                <span className="text-[8px] text-white font-bold">
                                  {slot.type === 'ev' ? '⚡' : slot.type === 'handicapped' ? '♿' : '⭐'}
                                </span>
                              </div>
                            )}
                            ...
                            } text-xs opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap z-20`}>
                              <div className="font-semibold">Slot {slot.id}</div>
                    ...
                    <div className="absolute bottom-4 right-4">
                      <div className={`${
                        isDarkMode ? 'bg-white/10' : 'bg-gray-900/10'
                      } backdrop-blur-sm rounded-xl p-4 space-y-2 border ${
                        isDarkMode ? 'border-white/10' : 'border-gray-200/20'
                      }`}>
                        ...
                        <div className="flex items-center space-x-2 text-sm">
                          ...
                          <span className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>Charging</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    <div className={`${
                      isDarkMode ? 'bg-white/5' : 'bg-gray-900/5'
                    } backdrop-blur-sm p-4 rounded-xl text-center border ${
                      isDarkMode ? 'border-white/10' : 'border-gray-200/20'
                    }`}>
                      <div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">20</div>
                      <div className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total Slots</div>
                    </div>
                    <div className={`${
                      isDarkMode ? 'bg-white/5' : 'bg-gray-900/5'
                    } backdrop-blur-sm p-4 rounded-xl text-center border ${
                      ...
                      <div className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Occupied</div>
                    </div>
                    <div className={`${
                      isDarkMode ? 'bg-white/5' : 'bg-gray-900/5'
                    } backdrop-blur-sm p-4 rounded-xl text-center border ${
                      ...
                      <div className="text-2xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">€89.40</div>
                      <div className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Today's Revenue</div>
                    </div>
                    <div className={`${
                      isDarkMode ? 'bg-white/5' : 'bg-gray-900/5'
                    } backdrop-blur-sm p-4 rounded-xl text-center border ${
                      ...
                      <div className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Available</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            {/* Enhanced Sidebar - Slot Details */}
            <div className="lg:col-span-1">
              <Card className={`${
                isDarkMode ? 'bg-white/5' : 'bg-white/20'
              } backdrop-blur-xl border ${
                isDarkMode ? 'border-white/10' : 'border-gray-200/20'
              } rounded-3xl shadow-2xl h-full`}>
                  ...
                  {selectedSlot ? (
                      ...
                      <div className={`${
                        ...
                        <div className="space-y-3 text-sm">
                          <div className="flex justify-between items-center">
                            ...
                            <Badge variant="outline" className={
                              selectedSlot.status === 'occupied' ? 'bg-red-500/10 border-red-500/30 text-red-400' :
                              selectedSlot.status === 'available' ? 'bg-green-500/10 border-green-500/30 text-green-400' :
                              selectedSlot.status === 'reserved' ? 'bg-yellow-500/10 border-yellow-500/30 text-yellow-400' :
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-400">{selectedSlot.price}</span>
                          </div>
                          ...
                          {selectedSlot.timeLeft && (
                            <div className="flex justify-between">
                              <span className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>Time Left:</span>
                              <span className="font-medium text-blue-400">{selectedSlot.timeLeft}</span>
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    <div className={`text-center py-8 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      ...
                      <p className="text-sm leading-relaxed">
                        Click on any parking slot to view detailed information and management options.
                      </p>
                    </div>
                  )}
                </CardContent>
          ...
          <div className="text-center mt-16">
            <Card className={`${
              ...
              isDarkMode ? 'border-white/10' : 'border-gray-200/20'
            } rounded-3xl shadow-2xl inline-block`}>
              <CardContent className="p-8">
                <h3 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                  Ready to build your own smart parking layout?
                </h3>
                <p className={`mb-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Start designing your parking space with our intuitive drag-and-drop layout builder.
                </p>
                <Button 
      ...
      {/* Pricing Section */}
      <section ref={pricingRef} className={`py-20 px-4 sm:px-6 lg:px-8 ${isDarkMode ? 'bg-black/10' : 'bg-white/30'} backdrop-blur-sm`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Choose Your
      ...
      <section data-section="testimonials" className={`py-20 px-4 sm:px-6 lg:px-8 ${isDarkMode ? 'bg-black/5' : 'bg-white/20'} backdrop-blur-sm`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Trusted by
      ...
      <section className={`py-20 px-4 sm:px-6 lg:px-8 ${isDarkMode ? 'bg-black/20' : 'bg-white/30'} backdrop-blur-sm`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Everything You Need for
              ...
              <Card 
                ...
                className={`${
                  isDarkMode 
                    ...
                    : 'bg-white/40 border-gray-300/30 hover:border-gray-300/50'
                } backdrop-blur-xl transition-all duration-300 group hover:scale-105 hover:shadow-2xl`}
              >
                <CardContent className="p-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card 
                ...
                } backdrop-blur-xl text-center group hover:scale-105 transition-all duration-300 hover:shadow-2xl`}
              >
                <CardContent className="p-8">
      ...
      {/* Contact & CTA Banner */}
      <section data-section="contact" className={`py-20 px-4 sm:px-6 lg:px-8 ${isDarkMode ? 'bg-black/5' : 'bg-white/20'} backdrop-blur-sm relative overflow-hidden`}>
        {/* Animated Background */}
      ...
      <div className={`md:hidden fixed bottom-0 left-0 right-0 ${
        ...
        <div className="flex justify-between items-center">
          ...
          <button 
            onClick={handleGetStarted}
            className="flex flex-col items-center space-y-1 px-2 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white transition-all duration-300 hover:scale-105"
          >
